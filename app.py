...
def calculate_ballast_and_buoyancy(params, C2, C4, rho_ballast_wet, rho_ballast_dry, rho_water):
...
def net_vertical_load(params, F_z, rho_conc, rho_ballast_wet, rho_ballast_dry, rho_water):
    ...
    B_wet, B_dry, W = calculate_ballast_and_buoyancy(params, C2, C4, rho_ballast_wet, rho_ballast_dry, rho_water)
